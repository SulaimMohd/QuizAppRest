...
//         <p className="text-lg font-medium mt-2">Score: <span className="bg-yellow-400 px-2 py-1 rounded-lg">{score *5}/50</span></p>
//         <p className="bg-blue-600 text-white px-4 py-2 rounded-lg mt-2 text-lg">Your ID: 784962</p>
//         </div>
//         </div>
...
//         ></textarea>
//         <button className="w-full mt-4 bg-blue-600 text-white">Submit Feedback</button>
//         </div>
//         </div>

//         <button className="mt-4 text-gray-600 flex items-center space-x-2"
//         onClick={()=> navigate('/feedbackAndScore')}
//         >
//         <span>🏠</span>
